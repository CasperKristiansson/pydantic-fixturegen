...
- Added a `docs/example-projects/customer-analytics` reference project showcasing dataset exports (`make datasets`), Hypothesis strategy generation (`make strategies`), and deterministic seeds for analytics pipelines.
